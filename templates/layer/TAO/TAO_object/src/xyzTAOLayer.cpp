...
void XyzTAOLayer::set_connection_timeout_orb(
    int timeout_ms)
{
...
void XyzTAOLayer::get_connection_timeout_orb(
    int & timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_);
...
void XyzTAOLayer::set_request_timeout_orb(
    int timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_, 0);
    if (!guard.locked())
...
void XyzTAOLayer::get_request_timeout_orb(
    int & timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_);
...
void XyzTAOLayer::set_request_timeout_thread(
    int timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_, 0);
    if (!guard.locked())
...
bool XyzTAOLayer::set_taolayer_retry_params(
    int loop_timeout_ms,
    int attempts,
    bool /*raise_event*/)
{
...
void XyzTAOLayer::get_taolayer_retry_params(
    int & loop_timeout_ms,
    int & attempts)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(set_tao_layer_params_mutex_);
...
void XyzTAOLayer::unregister_objects()
{
    if (init_)
    {
