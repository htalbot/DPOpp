#ifndef TEST_XYZ_SERVER_TAOLAYER_H
#define TEST_XYZ_SERVER_TAOLAYER_H
...
class Test_xyz_serverTAOLayer
{
    ...
    {
    public:
        CtrlEnd(Test_xyz_serverTAOLayer * tao_layer)
...
public:
    ...
    Test_xyz_serverTAOLayer();

    virtual ~Test_xyz_serverTAOLayer();
...
#endif // TEST_XYZ_SERVER_TAOLAYER_H
