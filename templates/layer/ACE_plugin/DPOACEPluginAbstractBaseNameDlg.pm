...
sub new {
    ...
    Wx::Event::EVT_LIST_ITEM_ACTIVATED($self, $self->{list_ctrl_ace_plugin_interfaces}->GetId, \&on_list_ctrl_ace_plugin_interfaces_activated);
...
sub on_list_ctrl_ace_plugin_interfaces_activated
{
    my ($self, $event) = @_;
    ...
    # wxGlade: DPOACEPluginAbstractBaseNameDlg::on_list_ctrl_ace_plugin_interfaces_activated <event_handler>
    warn "Event handler (on_list_ctrl_ace_plugin_interfaces_activated) not implemented";
    $event->Skip;
    # end wxGlade
}
