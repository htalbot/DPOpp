...
Test_xyz_serverTAOLayer::Test_xyz_serverTAOLayer()
: ctrl_end_(0)
, init_(false)
...
bool Test_xyz_serverTAOLayer::init(
    int argc,
    ACE_TCHAR *argv[],
    const char *orb_name)
{
...
CORBA::ORB_var Test_xyz_serverTAOLayer::orb()
{
...
void Test_xyz_serverTAOLayer::shutdown()
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_);
...
void Test_xyz_serverTAOLayer::get_connection_timeout_orb(
    int & timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_);
...
void Test_xyz_serverTAOLayer::set_request_timeout_orb(
    int timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_, 0);
    if (!guard.locked())
...
void Test_xyz_serverTAOLayer::get_request_timeout_orb(
    int & timeout_ms)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(shutting_down_mutex_);
...
bool Test_xyz_serverTAOLayer::set_taolayer_retry_params(
    int loop_timeout_ms,
    int attempts,
    bool /*raise_event*/)
{
...
void Test_xyz_serverTAOLayer::get_taolayer_retry_params(
    int & loop_timeout_ms,
    int & attempts)
{
    ACE_Guard<ACE_Recursive_Thread_Mutex> guard(set_tao_layer_params_mutex_);
...
void Test_xyz_serverTAOLayer::shutdown_i()
{
   if (init_)
   {
       unregister_objects();
