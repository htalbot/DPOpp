#ifndef TEST_XYZ_CLIENT_TAOLAYER_H
#define TEST_XYZ_CLIENT_TAOLAYER_H
...
class Test_xyz_clientTAOLayer
{
    ...
    {
    public:
        CtrlEnd(Test_xyz_clientTAOLayer * tao_layer)
...
public:
    ...
    Test_xyz_clientTAOLayer();

    virtual ~Test_xyz_clientTAOLayer();
...
#endif // TEST_XYZ_CLIENT_TAOLAYER_H
